...
def train(config, train_loader, model, optimizer, criterion, epoch):
    ...
    for step, (x, y) in enumerate(train_loader):
        ...
        accuracy = utils.top_accuracy(logits, y, topk=(1, 5))
...
if __name__ == "__main__":
    ...
    dataset_train, dataset_valid = datasets.get_dataset("cifar10", cutout_length=args.cutout)
    ...
    optimizer = torch.optim.SGD(model.parameters(), args.initial_lr, momentum=0.9, weight_decay=args.weight_decay)
    lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.epochs, eta_min=args.ending_lr)
